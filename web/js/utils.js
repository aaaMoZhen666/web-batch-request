...
!(function (global) {
    global.initRequestParamTable = function (tableId) {
        ...
        return {
            table,
            updateDefaultData: (newDefaultData) => {
                table.setData(JSON.parse(JSON.stringify(newDefaultData)))
                currentDefaultData = [...newDefaultData]
            }
        }
    }

    global.initResponseTable = function (tableId) {
        const table = new Tabulator(`#${tableId}`, {
            height: '100%',
            theme: 'bootstrap5',
            movableRows: true,
