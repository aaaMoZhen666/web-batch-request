const myApp = (function () {
    ...
    // 初始化表格
    appStore.tables.queryParams = initRequestParamTable('queryParamsTable')
    appStore.tables.bodyParams = initRequestParamTable('bodyParamsTable')
    appStore.tables.cookies = initRequestParamTable('cookiesTable')
    appStore.tables.headers = initRequestParamTable('headersTable')
